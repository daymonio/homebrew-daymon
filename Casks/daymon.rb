cask "daymon" do
  version "0.1.18"
  sha256 "e360cc5a44e0982747f2ba574d6a2d558d4fbc135e1faeb15064415cb56a8b7f"

  url "https://github.com/daymonio/daymon/releases/download/v#{version}/Daymon-0.1.18-universal.dmg"
  name "Daymon"
